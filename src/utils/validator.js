  ...
  return {
    checkValidate: (value) => {
      ...
      return re.test(value)
        ? undefined
        : "Password must contain at least 1 digit, 1 lower case";
    },
  };
};
  ...
  return {
    checkValidate: (value) => {
      return value.length >= min
        ? undefined
        : `This field must have at least ${min} character`;
    },
  };
};
...
export const isPrice = () => {
  return {
    checkValidate: (value) => {
      return value > 0 ? undefined : `Price must be greater than equal to 0`;
    },
  };
};
