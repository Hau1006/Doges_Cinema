...
function SignUp() {
  ...
  const ruleList = {
    ...
    xacNhanMatKhau: [
      isRequired(),
      minLength(6),
      isConfirmPaswword(dataForm.matKhau),
    ],
    hoten: [isRequired()],
    ...
    <div className={style.logn_page}>
      <div className={style.block_login}>
        ...
        <form id={style.form} onSubmit={handleSubmit}>
          ...
          <div className={style.form_group}>
            <label style={{ fontSize: "16px" }} htmlFor="hoten">
              Họ và tên <small className={style.text_danger}>*</small>
            </label>
            <input
              type="text"
              name="hoten"
          ...
          <div className={style.form_group}>
            <label style={{ fontSize: "16px" }} htmlFor="soDt">
              Số điện thoại <small className={style.text_danger}>*</small>
            </label>
            <input
              type="text"
              name="soDt"
            ...
            />
            <small className={style.text_danger}>{msgError.soDt}</small>
          </div>

          <div className={style.form_group}>
            <label style={{ fontSize: "16px" }} htmlFor="email">
              Email <small className={style.text_danger}>*</small>
            </label>
            <input
              type="text"
              name="email"
          ...
          <div className={style.form_group}>
            <label style={{ fontSize: "16px" }} htmlFor="xacNhanMatKhau">
              Confirm Password <small className={style.text_danger}>*</small>
            </label>
            <input
              type="password"
              name="xacNhanMatKhau"
            ...
            />
            <small className={style.text_danger}>
              {msgError.xacNhanMatKhau}
            </small>
          </div>
          <div className={`${style.option_forgot}`}>
            ...
            <span style={{ color: "white" }}>
              &nbsp;I Agree To The
              <span style={{ color: "rgb(49 215 169)" }}>
